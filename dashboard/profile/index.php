...
<body>
<div class="containers light-style flex-grow-1 container-p-y" style="padding:15px;">
                ...
                <div class="rrow">
                      ...
                      <div class="form-holder form-group">
                        <label class="form-label">First Name</label>
                          <i class="zmdi zmdi-account"></i>
                          <input type="text" class="form-control  mb-1" placeholder="First Name" id="firstName" name="firstName" required>
                      </div>
                      <div class="form-holder form-group">
                        <label class="form-label">Last Name</label>
                          <i class="zmdi zmdi-account"></i>
                          <input type="text" class="form-control  mb-1" placeholder="Last Name" id="lastName" name="lastName" required>
                      </div>
                </div>
                <div class="form-holder form-group">
                  <i class="zmdi zmdi-account"></i>
