      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-info">
            ...
            <p>
              Ngong Road <br>
              Nairobi, Kenya<br><br>
              <strong>Phone:</strong> +254 7927 56008<br>
              <strong>Email:</strong> info@idonate.org<br>
            </p>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="#">Register/Login</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="#">Agent Login</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="#">Host a Blood Drive</a></li>
